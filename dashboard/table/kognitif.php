			...
			<div class="grid-body">
				<table id="dataTables1" class="table table-hover display" cellspacing="0" width="100%">
					...
					<tbody>
						<?php 
							$no 		=	1;
							$nilai 		=	mysqli_query($db, "SELECT nilai.nilai_id, nilai.nilai_poin, users.name, users.access, jenisnilai.jenis_nama, kelas.kelas_nama, semester.semester_nama, tahun.tahun_nama
														FROM nilai
