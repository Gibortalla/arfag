                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    ...
                                    $sql    =   mysqli_query($db, "SELECT * FROM kelas WHERE kelas_id='$kelas'");
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    ...
                                    $sql    =   mysqli_query($db, "SELECT * FROM semester WHERE semester_id='$semester'");
                                    $row    =   mysqli_fetch_array($sql);
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    ...
                                    $sql    =   mysqli_query($db, "SELECT * FROM tahun WHERE tahun_id='$tahun'");
                                    $row    =   mysqli_fetch_array($sql);
                        ...
                        <form role="form" method="post">
                            <?php 
                                if (isset($_POST['cari-nilai'])) {
                                    ...
                                    $kognitif   =   mysqli_query($db, "SELECT users.id, users.name, users.access, kelas.kelas_nama FROM users
