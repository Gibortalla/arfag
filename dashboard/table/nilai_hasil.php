                ...
                <div class="col-md-12" style="padding-top:20px;">
                    <table>
                        ...
                        <tr>
                            ...
                            <?php 
                            	$name 	=	$_SESSION['name'];
                            	$siswa 	=	mysqli_query($db, "SELECT nomor_induk FROM users WHERE name='$name'");
                        ...
                        <tr>
                            ...
                            <td>
                            	<?php 
                            		$k = $_SESSION['kelas']; 
                            		$kelas = mysqli_query($db, "SELECT * FROM kelas WHERE kelas_id='$k'");
                ...
                <table class="table">
                    ...
                    <tbody>
                            <?php 
                                ...
                                $nilai      =   mysqli_query($db, "SELECT AVG(nilai_poin) AS nilai, users.name, semester.semester_nama,
                                							tahun.tahun_nama
                                							FROM nilai
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<select class="form-control" name="tahun" required>
								<?php 
									$tahun  	=	mysqli_query($db, "SELECT * FROM tahun");
