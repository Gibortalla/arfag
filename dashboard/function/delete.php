<?php 
	...
	if (isset($_GET['admin-delete'])) {
		...
		$delete 	=	mysqli_query($db, "DELETE FROM alat WHERE alat_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($db, "DELETE FROM bahan WHERE bahan_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($db, "DELETE FROM kelas WHERE kelas_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($db, "DELETE FROM semester WHERE semester_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($db, "DELETE FROM tahun WHERE tahun_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($db, "DELETE FROM jenisnilai WHERE jenis_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($db, "DELETE FROM jenisperangkat WHERE jenisperangkat_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($db, "DELETE FROM nilai WHERE nilai_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($db, "DELETE FROM download WHERE id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($db, "DELETE FROM jadwal WHERE jadwal_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($db, "DELETE FROM jam WHERE jam_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($db, "DELETE FROM galeri WHERE galeri_id = $id");
		if ($delete) {
