<?php 
	...
	if (isset($_POST['create-admin'])) {
		...
		$admin 			=	mysqli_query($db, "INSERT INTO users (`id`, `name`, `username`, `password`, `alamat`, 
...
<?php 
	...
	if (isset($_POST['create-guru'])) {
		...
		$guru 			=	mysqli_query($db, "INSERT INTO users (`id`, `nomor_induk`, `name`, `username`, `password`, `alamat`, 
...
<?php 
	...
	if (isset($_POST['create-siswa'])) {
		...
		$siswa 			=	mysqli_query($db, "INSERT INTO users (`id`, `nomor_induk`, `name`, `username`, `password`, `alamat`, 
													`telp`, `status`, `gender`, `foto`, `kelas_id`, `access`) 
...
<?php 
	...
	if (isset($_POST['create-alat'])) {
		...
		$alat 			=	mysqli_query($db, "INSERT INTO alat (`alat_id`, `alat_nama`, `alat_jenis`, `alat_jumlah`, `alat_rusak`, `alat_satuan`) 
...
<?php 
	...
	if (isset($_POST['create-bahan'])) {
		...
		$bahan 			=	mysqli_query($db, "INSERT INTO bahan (`bahan_id`, `bahan_nama`, `bahan_jenis`, `bahan_jumlah`, `bahan_rusak`, `bahan_satuan`) 
										VALUES (NULL, '$nama', '$jenis', '$jumlah', '$rusak', '$satuan')");
...
<?php 
	...
	if (isset($_POST['create-kelas'])) {
		...
		$kelas 			=	mysqli_query($db, "INSERT INTO kelas (`kelas_id`, `kelas_nama`) 
										VALUES (NULL, '$nama')");
...
<?php 
	...
	if (isset($_POST['create-semester'])) {
		...
		$semester 			=	mysqli_query($db, "INSERT INTO semester (`semester_id`, `semester_nama`) 
										VALUES (NULL, '$nama')");
...
<?php 
	...
	if (isset($_POST['create-tahun'])) {
		...
		$tahun 			=	mysqli_query($db, "INSERT INTO tahun (`tahun_id`, `tahun_nama`) 
										VALUES (NULL, '$nama')");
...
<?php 
	...
	if (isset($_POST['create-jenis'])) {
		...
		$jenis 			=	mysqli_query($db, "INSERT INTO jenisnilai (`jenis_id`, `jenis_nama`) 
										VALUES (NULL, '$nama')");
...
<?php 
	...
	if (isset($_POST['create-jenisperangkat'])) {
		...
		$jenis 			=	mysqli_query($db, "INSERT INTO jenisperangkat (`jenisperangkat_id`, `jenisperangkat_nama`, `jenisperangkat_type`) 
...
<?php 
	...
	if (isset($_POST['create-jadwal'])) {
		...
		$jadwal 			=	mysqli_query($db, "INSERT INTO jadwal (`jadwal_id`, `jam_id`, `jadwal_tanggal`, `id`, `kelas_id`) 
...
<?php 
	...
	if (isset($_POST['create-jam'])) {
		...
		$jam 			=	mysqli_query($db, "INSERT INTO jam (`jam_id`, `jam_nama`) 
										VALUES (NULL, '$nama')");
...
<?php 
	if (isset($_POST['afektif-proses'])) {
		...
		for($x=0;$x<$jumlahdata;$x++) {
			$nilai	=	mysqli_query($db, "INSERT INTO nilai (`nilai_id`, `id`, `jenis_id`, `semester_id`, `tahun_id`, `nilai_poin`) 
	...
	if(isset($_POST['upload'])){
        ...
        if(in_array($file_ext, $allowed_ext) === true){
            if($file_size < 20440700){
                ...
                $in = mysqli_query($db, "INSERT INTO download VALUES(NULL, '$tgl', '$nama', '$file_ext', '$file_size', '$lokasi')");
                if($in){
...
<?php
    ...
    if (isset($_POST['upload-foto'])) {
        ...
        $galeri = mysqli_query($db, "INSERT INTO galeri (galeri_nama, galeri_keterangan, galeri_link, galeri_tgl) VALUES('$nama','$keterangan','$link', now())");
...
<?php 
	if (isset($_POST['absen-proses'])) {
		...
		for($x=0;$x<$jumlahdata;$x++) {
			$absen	=	mysqli_query($db, "INSERT INTO absen (`absen_id`, `id`, `absen_tgl`, `absen_ket`) 
