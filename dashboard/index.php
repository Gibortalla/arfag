							...
							<div class="col-lg-2 col-md-4 col-sm-6">
								<div class="grid widget bg-light-blue">
									<div class="grid-body">
										...
										<?php 
											$users 		=	mysqli_query($db, "SELECT COUNT(name) AS total FROM users WHERE access='admin'");
							...
							<div class="col-lg-2 col-md-4 col-sm-6">
								<div class="grid widget bg-red">
									<div class="grid-body">
										...
										<?php 
											$guru 		=	mysqli_query($db, "SELECT COUNT(name) AS total FROM users WHERE access='guru'");
							...
							<div class="col-lg-2 col-md-4 col-sm-6">
								<div class="grid widget bg-orange">
									<div class="grid-body">
										...
										<?php 
											$siswa 		=	mysqli_query($db, "SELECT COUNT(name) AS total FROM users WHERE access='siswa'");
							...
							<div class="col-lg-2 col-md-4 col-sm-6">
								<div class="grid widget bg-green">
									<div class="grid-body">
										...
										<?php 
											$alat 		=	mysqli_query($db, "SELECT COUNT(alat_nama) AS total FROM alat");
							...
							<div class="col-lg-2 col-md-4 col-sm-6">
								<div class="grid widget bg-purple">
									<div class="grid-body">
										...
										<?php 
											$bahan 		=	mysqli_query($db, "SELECT COUNT(bahan_nama) AS total FROM bahan");
							...
							<div class="col-lg-2 col-md-4 col-sm-6">
								<div class="grid widget bg-teal">
									<div class="grid-body">
										...
										<?php 
											$alat 		=	mysqli_query($db, "SELECT COUNT(nama_file) AS total FROM download");
											$data 		=	mysqli_fetch_array($alat);
										?>
										<span class="value"><?php echo $data['total']; ?></span>
									</div>
